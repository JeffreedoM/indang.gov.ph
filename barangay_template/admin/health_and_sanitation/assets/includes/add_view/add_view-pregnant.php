            ...
            <div class="page-body">
                <form action="../query.php" method="POST" enctype="multipart/form-data" class="add-resident__form">
                    ...
                    <div class="container_vaccine">
                        ...
                        <input type="text" name="pregnant_occupation" value="<?php echo $pregnant['pregnant_occupation'] ?>" <?php echo $action_read;?> class="<?php echo $action_class;?>">
                        ...
                        <select name="pregnant_status" id="" <?php echo $action_read;?> class="<?php echo $action_class;?>">
                            <option value="Single" <?= ($pregnant['pregnant_status'] == 'Single') ? 'selected' : '' ?>> Single</option>
                            <option value="Married" <?= ($pregnant['pregnant_status'] == 'Married') ? 'selected' : '' ?>> Married</option>
                            <option value="Separated" <?= ($pregnant['pregnant_status'] == 'Separated') ? 'selected' : '' ?>> Separated</option>
                            <option value="Widow" <?= ($pregnant['pregnant_status'] == 'Widow') ? 'selected' : '' ?>> Widow</option>
                        </select>
