<?php
    ...
    if (isset($_POST['submit_add_death'])) {
        ...
        if ($record) {
            ...
            $sql = "INSERT INTO death (resident_id, firstname, lastname, middlename, suffix, sex, birthdate,
                    ...
                    VALUES (:resident_id, :firstname, :lastname, :middlename, :suffix, :sex, :birthdate,
                    :age, :civil_status, :contact, :contact_type, :height, :weight, :religion, :occupation_status, :occupation,
                    :address, :image, :death_cause, :death_date)";
    ...
    if (isset($_POST['submit_add_inventory-vaccine'])) {
        ...
        // Prepare the SQL statement for inserting data into the officials table
        $sql = "INSERT INTO vaccine_inventory (vaccineName, vaccineStatus, vaccineQuantity,vaccineExpDate, vaccineDescrip) 
        VALUES (:vaccineName, :vaccineStatus, :vaccineQuantity, :vaccineExpDate, :vaccineDescrip)";
