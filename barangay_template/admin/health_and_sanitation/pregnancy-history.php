...
$sql = "SELECT * FROM pregnant_history ph
JOIN resident r ON r.resident_id = ph.id_resident
WHERE r.barangay_id = :barangayId";
$stmt = $pdo->prepare($sql);
$stmt->bindParam(':barangayId', $barangayId, PDO::PARAM_INT);
$stmt->execute();
$pregnant_history = $stmt->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="wrapper ">
            ...
            <div class="page-header" style="margin: 0 !important;">
                ...
                <div class="border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center dark:text-gray-400">
                        <li class="mr-2">
                            <a href="pregnant.php" class="inline-flex p-4 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                                Pregnant
                            </a>
                        </li>
                        <li class="mr-2">
            ...
            <div class="page-body">
                <table id="pregnancy-history" class="row-border hover">
                    ...
                    <tbody>
                        <?php foreach ($pregnant_history as $pregnant) : ?>
                            <tr>
