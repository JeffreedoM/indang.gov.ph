...
if (isset($_FILES['announcement_photo']) && $_FILES['announcement_photo']['error'] == UPLOAD_ERR_OK) {
  ...
  if ($fileType != 'image/png' && $fileType != 'image/jpeg' && $fileType != 'image/jpg') {
    ...
    $insertsql = "INSERT INTO announcement (announcement_id,brgy_id, announcement_title, announcement_what,announcement_where,announcement_when, receiver, announcement_message, announcement_photo)
  VALUES ('','$barangayId', '$title','$announcement_what','$announcement_where','$announcement_when', '$receiver', '$message', '$fileNameNew')";
