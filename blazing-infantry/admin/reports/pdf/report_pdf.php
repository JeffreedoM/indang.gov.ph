...
if (isset($id)) {
    ...
    /* Classification */
    // $categories = array(
    //     $total_residents = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId ORDER BY lastname ASC")->fetchAll(),
    //     $adult = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND age >= 18 AND age <= 59 ORDER BY lastname ASC")->fetchAll(),
    //     $employed = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND occupation_status != 'Unemployed' AND occupation_status != '' ORDER BY lastname ASC")->fetchAll(),
    //     $female = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND sex = 'Female' ORDER BY lastname ASC")->fetchAll(),
    //     $infant = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND age = 0 ORDER BY lastname ASC")->fetchAll(),
    //     $male = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND sex = 'Male' ORDER BY lastname ASC")->fetchAll(),
    //     $children = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND age >= 1 AND age <= 12")->fetchAll(),
    //     $pregnant = $pdo->query("SELECT * FROM resident INNER JOIN pregnant ON resident.resident_id = pregnant.id_resident WHERE is_alive = 1 AND barangay_id = $barangayId ORDER BY lastname ASC")->fetchAll(),
    //     $senior = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND age >= 60 ORDER BY lastname ASC")->fetchAll(),
    //     $teens = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND age >= 13 AND age <= 17 ORDER BY lastname ASC")->fetchAll(),
    //     $unemployed = $pdo->query("SELECT * FROM resident WHERE is_alive = 1 AND barangay_id = $barangayId AND (occupation_status = 'Unemployed' OR occupation_status = '') ORDER BY lastname ASC")->fetchAll(),
    //     $death = $pdo->query("SELECT * FROM resident WHERE barangay_id = $barangayId AND is_alive = 0 ORDER BY lastname ASC")->fetchAll()
