            ...
            <div class="row">
                <div class="card-container">
                    <div class="card">
                        ...
                        <button type="button" data-modal-target="secretary" data-modal-toggle="secretary" class="mt-2 px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            More Info <i class="fa-solid fa-circle-info"></i>
                        </button>
                        <div id="secretary" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="secretary">
                                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                        <span class="sr-only">Close modal</span>
                                    ...
                                    <div class="p-6 text-center">
                                        <img src="<?php echo $brgySecretary['image'] ?>" alt="" class="mx-auto">
                                        <h1 class="card-title"><?php echo $brgySecretary['name'] ?></h1>
                                        <p class="card-body ">Barangay Secretary</p>
                                        <div class="info p-6 mt-3 border-t border-gray-200 dark:border-gray-600">
                                            <div>
                                                <span class="text-sm font-semibold text-gray-900 dark:text-white">Gender:</span>
                                                <span class="text-sm"><?php echo $brgySecretary['gender'] ?></span>
                                            </div>
                                            <div>
                                                <span class="text-sm font-semibold text-gray-900 dark:text-white">Birthday:</span>
                                                <span class="text-sm"><?php echo $brgySecretary['birthday'] ?></span>
                                            </div>
                                            <div>
                                                <span class="text-sm font-semibold text-gray-900 dark:text-white">Civil Status:</span>
                                                <span class="text-sm"><?php echo $brgySecretary['status'] ?></span>
                                            </div>
                                            <div>
                                                <span class="text-sm font-semibold text-gray-900 dark:text-white">Religion:</span>
                                                <span class="text-sm"><?php echo $brgySecretary['religion'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
