        ...
        <div class="wrapper">
            ...
            <div class="page-body">
                ...
                <form action="includes/edit-form.inc.php" method="POST" id="create-form">
                    ...
                    <button type="submit" name="update-form" class="tracking-wider w-full mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Form</button>
                </form>
            </div>
        </div>
