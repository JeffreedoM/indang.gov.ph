...
<header>
    ...
    <div style="box-shadow: 0px 3px 21px 0px rgb(0 0 0 / 20%)" id="dropdownAvatarName" class="z-10 hidden bg-white divide-y font-normal divide-gray-100 shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
        ...
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
            ...
            $logout = (strpos($currentURL, "account-settings") !== false) ? "../logout.php" : $barangayURL . 'logout.php';
            ?>
            <li>
                <!-- Use the PHP variable $accountSettings to set the href attribute of the <a> tag -->
                <a href="<?php echo $accountSettings; ?>" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Account Settings</a>
            </li>
        </ul>
        <div class="py-2">
