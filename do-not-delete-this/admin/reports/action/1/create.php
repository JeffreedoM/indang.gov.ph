    ...
    <main class="main-content">
                ...
                <div class="body">
                    <form action="" method="POST">
                        ...
                        <div class="field1">
                            ...
                            <input type="text" class="form-control" name="datepicker" id="datepicker" placeholder="Month/Year" style="height: 30px; margin-top: .3rem;  " />
                        </div>
                        <div class="field">
                            <textarea name="reportContent" id="" cols="30" rows="10" maxlength="500" style="width : 70%"></textarea>
                        </div>
                        <div class="fieldBtn">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($conn->connect_error) {
                ...
                $stmt = $conn->prepare("INSERT INTO report_accomplishment (acc_name, acc_content) VALUES (?,?)");
                $stmt->bind_param("ss", $reportName, $reportContent);
                $stmt->execute();
                $stmt->close();
            }
