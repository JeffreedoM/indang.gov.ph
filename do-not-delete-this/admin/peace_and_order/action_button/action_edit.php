...
// $o_ids = [];
// $c_ids = [];
// foreach (getIncidentOffender($pdo, $incident_id) as $id) {
//     $o_ids[] = $id['resident_id'];
// }
// foreach (getIncidentComplainant($pdo, $incident_id) as $id) {
//     $c_ids[] = $id['resident_id'];
// }
            ...
            <div class="page-body" style="overflow-x:auto; min-height: 60vh;">
                ...
                <form id="myForm" action="" method="POST">
                    ...
                    <div class="my-3">
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" name="i_title" value="<?php echo $list['incident_title']; ?>" required class="block w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5">
                            </div>
                    ...
                    <div>
                        ...
                        <textarea name="narrative" id="message" rows="4" required class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."><?php echo $list['narrative']; ?></textarea>
                    </div>
            </div>
