...
rows.forEach(row => {
  row.addEventListener('click', () => {
    ...
    if (row.getAttribute('data-modal-hide') === 'offenderModal') {
      ...
      // Check if the selected resident is already the complainant
      if (selectedComplainant && selectedComplainant.id === selectedId) {
      ...
      complainantIdInput.value = selectedComplainant ? selectedComplainant.id : '';
      complainantFNameInput.value = selectedComplainant ? selectedComplainant.fname : '';
      complainantLNameInput.value = selectedComplainant ? selectedComplainant.lname : '';
      contactInput.value = selectedComplainant ? selectedComplainant.contact : '';
      ...
      // Check if the selected resident is already the offender
      if (selectedOffender && selectedOffender.id === selectedId) {
